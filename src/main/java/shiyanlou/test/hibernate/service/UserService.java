...
//         q.setParameter(0, "张俊俏");
     ...
     //    3. 原生 SQL 查询
         System.out.println(("查询！！select * from user_info_byzjq where user_username = "+username));
         SQLQuery q = session.createSQLQuery("select * from user_info_byzjq where username = '"+username+"'").addEntity(User.class);
...
/*        JSONArray json = new JSONArray();
        ...
        for (User e : list) {
            System.out.println(e.getUsername() + ", password: " + e.getPassword());
            System.out.println("查查查查查查查查查查查查查查查");
	...
	public boolean searchUsergrantedbySQL(String username)   {
        ...
        session.beginTransaction();
         ...
         System.out.println(("查询！！select * from user_info_byzjq where username = "+username));
         SQLQuery q = session.createSQLQuery("select * from user_info_byzjq where username = '"+username+"'").addEntity(User.class);
...
//          3. 原生 SQL 查询
//         SQLQuery q = session.createSQLQuery("select * from user_info_byzjq").addEntity(User.class);
	...
	/*public void onetoall(){
        ...
        User user1 = new User();
        user1.setUsername("令狐冲");
        user1.setPassword("555");
        User user2 = new User();
        user2.setUsername("令计划");
